...
function GetPWDocumentData
{
    ...
    if($null -ne $pwFolder)
    {
        ...
        try
        {
            $pwFolderDocumentSize = Get-PWFolderDocumentSize -InputFolder $pwFolder
        }
        catch
        {
            $pwFolderDocumentSize = $null
    ...
    else # NOT ($null -ne $pwFolder)
    {
        LogError "Null PW folder in GetPWDocumentData"
        $Script:ReturnObject.Good2Go = $false
    }

    return $pwFolderDocumentSize
}
    ...
    if($null -ne $Script:topPublicFolder)
    {
        ...
        if($null -ne $retVal.PublicFolder)
        {
            ...
            if($retVal.PFDocumentCount -gt 0)
            {
                ...
                if($pwFolderExists)
                {
                    $retVal.PWFolderDocumentSize = GetPWDocumentData -pwFolder $retval.ProjectWiseFolder
