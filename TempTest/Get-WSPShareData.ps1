...
$translationCSVPath = ".\Dataclassification\AllShares-20241014.csv"
$folderToSaveTo = ".\Dataclassification\Data"
$di = "\\?\UNC\boifs1\xchange"

LD ".\Dataclassification\AllShares-20241014.csv" ".\Dataclassification\Data" "\\boi-smb01\xchange"
