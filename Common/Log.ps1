...
class Log
{
    ...
    #>
    static [void] Init([String] $logRootPath, [String] $logName, [System.Int32] $maxLogAge, [System.Int32] $lineCache = 1, [LogLevel] $loggingLevel = [LogLevel]::INFO, [System.Collections.Generic.List[String]] $startLog = $null)
    {
