...
$clusterNames = @("CDC-INT-CLUSTER-01", "DDC-INT-CLUSTER-01")
$a = 0
while($a -lt $clusterNames.Length)
{
    ...
    $clusterStats = Get-Stat -Entity $cluster -Stat "mem.consumed.average","cpu.usagemhz.average" -Start $start -Finish $finish -IntervalSecs 5
